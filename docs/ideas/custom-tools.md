...
The agents can read files, write files, grep, navigate symbols, find callers, and explore the directory tree. That's it. They can't run your tests, check your linter, hit your API, query your database, or do anything specific to your project. For a tool that's supposed to take over your workflow, that's a gap.
...
Settings modal should show loaded tools with health status.
